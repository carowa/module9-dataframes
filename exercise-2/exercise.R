...
number.of.raises <- salaries$got.raise[salaries$got.raise == TRUE]
print(length(number.of.raises))
View(salaries)

# What was the value of the highest raise?
max.raise <- (salaries$raise[salaries$raise == max(salaries$raise)])

# What was the "name" of the employee who received the highest raise?
best.employee <- salaries[salaries$raise == max(salaries$raise), 'employees']
print(best.employee)
